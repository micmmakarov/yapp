...
class ContributorsControllerTest < ActionController::TestCase
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post :create, contributor: { description: @contributor.description, pic: @contributor.pic, title: @contributor.title }
    end
  ...
  test "should update contributor" do
    put :update, id: @contributor, contributor: { description: @contributor.description, pic: @contributor.pic, title: @contributor.title }
    assert_redirected_to contributor_path(assigns(:contributor))
  end
